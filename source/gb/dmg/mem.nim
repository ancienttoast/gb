...
const
  MemSlotSize*: array[MemSlot, MemArea] = [
    ...
    0xc000'u16..0xcfff'u16,
    0xd000'u16..0xdfff'u16,
    ...
    0xff68'u16..0xff6b'u16,
    0xff6c'u16..0xff6c'u16,
    0xff70'u16..0xff7f'u16,
...
func findHandler(self: Mcu, address: MemAddress): MemHandler =
  result = case address
    ...
    of 0xc000..0xcfff: self.handlers[msWorkRam0]
    of 0xd000..0xdfff: self.handlers[msWorkRamN]
    ...
    of 0xff40..0xff4c: self.handlers[msLcdIo]
    of 0xff4d..0xff4f: self.handlers[msCgbSwitch]
